...
<p align="center">
  <em>This library, created in accordance with the principles of object-oriented programming (OOP), is a set of reusable components that simplify the creation of interactive and adaptive user interfaces. Regardless of whether you are creating a small project or a large-scale application, this library will save you time and effort. The library will continue to be updated, this is not its latest version.</em>
</p>
